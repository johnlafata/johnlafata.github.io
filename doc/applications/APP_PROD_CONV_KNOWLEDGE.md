I am going to write a basic chatbot which I'm going to use as a research assistant.   This is a more complex application and I'll extend what I've written from the simpler application. I'm going to use the same tools as the account planning app, but I'm going to add some additional tools to help me with training and fine-tuning the model.
