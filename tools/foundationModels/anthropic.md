Using Anthropic is pretty simple, you need to register with open ai to get an api key, then you can use the Anthropic python library to interact with the api.   
